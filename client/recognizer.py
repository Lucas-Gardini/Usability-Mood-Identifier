...
class Recognizer:
    def recognize(self, video_path):
        ...
        model_path = 'client/trained_models/detection_models/face_detection/deploy.prototxt'
        weights_path = 'client/trained_models/detection_models/face_detection/res10_300x300_ssd_iter_140000.caffemodel'
        net = cv2.dnn.readNetFromCaffe(model_path, weights_path)

        emotion_model_path = 'client/emotion_model.hdf5'
